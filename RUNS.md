...
| M2_REMOTE_LOGPROB_SMOKE_PENDING | 2026-06-17 01:38 | M2 | `python scripts/compute_logprobs.py --model Qwen/Qwen2.5-1.5B-Instruct --max-samples 5 ...` | remote_pending | `outputs/runs/*_m2_logprob_smoke` | pending |
