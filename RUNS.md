...
| M3_REMOTE_DENSE_MARGIN_SMOKE_PENDING | 2026-06-17 01:49 | M3 | `python scripts/compute_dense_margins.py --instruct-model Qwen/Qwen2.5-1.5B-Instruct --base-model Qwen/Qwen2.5-1.5B --max-samples 20 ...` | remote_pending | `outputs/runs/*_m3_dense_margin_smoke` | pending |
